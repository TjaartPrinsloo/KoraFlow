...
def request_verification_code():
	...
	try:
		...
		frappe.log_error(f"Failed to send verification email: {str(e)}", "Bank Details Verification")
		return {
			"success": False,
...
def verify_and_update_bank_details(account_holder_name, bank_name, account_number, 
	...
	try:
		...
		frappe.log_error(f"Failed to update bank details: {str(e)}", "Bank Details Update")
		return {
			"success": False,
